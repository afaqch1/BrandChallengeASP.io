...
{
    [DbContext(typeof(BrandChallengeMigrationsDbContext))]
    partial class BrandChallengeMigrationsDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BrandChallenge.Brands.Brand", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("BrandChallenge.Challenges.Challenge", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppChallenges");
                });

            modelBuilder.Entity("BrandChallenge.Tricks.Trick", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BrandChallenge.Challenges.Challenge", b =>
                {
                    b.HasOne("BrandChallenge.Brands.Brand", null)
                        .WithMany()
                        .HasForeignKey("BrandId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BrandChallenge.Brands.Brand", "Brand")
                        .WithMany("Challenges")
            ...
            modelBuilder.Entity("BrandChallenge.Tricks.Trick", b =>
                {
                    b.HasOne("BrandChallenge.Challenges.Challenge", null)
                        .WithMany()
                        .HasForeignKey("ChallengeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BrandChallenge.Challenges.Challenge", "Challenge")
                        .WithMany("Tricks")
