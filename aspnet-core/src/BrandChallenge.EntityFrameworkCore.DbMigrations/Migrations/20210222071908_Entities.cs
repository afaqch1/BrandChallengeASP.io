...
namespace BrandChallenge.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Points = table.Column<float>(type: "real", maxLength: 128, nullable: false),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppChallenges_AppBrands_BrandId",
                        column: x => x.BrandId,
                        principalTable: "AppBrands",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppChallenges_AppBrands_BrandId1",
                        column: x => x.BrandId1,
                        principalTable: "AppBrands",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppTricks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppTricks_AppChallenges_ChallengeId",
                        column: x => x.ChallengeId,
                        principalTable: "AppChallenges",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppTricks_AppChallenges_ChallengeId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppChallenges_BrandId",
                table: "AppChallenges",
                column: "BrandId");

            migrationBuilder.CreateIndex(
                name: "IX_AppChallenges_BrandId1",
                table: "AppChallenges",
                column: "BrandId1");

            migrationBuilder.CreateIndex(
                name: "IX_AppTricks_ChallengeId",
                table: "AppTricks",
                column: "ChallengeId");

            migrationBuilder.CreateIndex(
                name: "IX_AppTricks_ChallengeId1",
                table: "AppTricks",
                column: "ChallengeId1");
