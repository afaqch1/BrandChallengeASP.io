...
namespace BrandChallenge.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
       ...
       public float Points { get; set; }
         ...
         *
         * 1. Update BrandChallengeDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update BrandChallengeEfCoreEntityExtensionMappings to extend the IdentityUser entity
